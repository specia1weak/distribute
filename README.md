...
为了验证 Flink 在真实物理网络环境下的分布式协同能力，本次实验摒弃了单机模拟方案，转而在校园局域网（Campus LAN）环境下，利用小组成员各自的笔记本电脑，基于 **WSL2 (Windows Subsystem for Linux)** 构建了跨物理机的真实分布式集群。
  ...
  * **硬件配置详情**：
    ...
    | :--- | :--- | :--- | :--- |:-----------------------|
    | **Master / Node-01**<br>(JobManager + TM) | 组员 A 笔记本<br>(Lenovo Legion) | AMD Ryzen 7 / 32GB | WSL2 (Ubuntu 22.04) | 4GB                    |
    | **Worker / Node-02**<br>(TaskManager) | 组员 B 笔记本<br>(Dell XPS 15) | Intel i7-12700H / 16GB | WSL2 (Ubuntu 20.04) | 4GB                    |
    | **Worker / Node-03**<br>(TaskManager) | 组员 C 笔记本<br>(MacBook/HP) | Intel i5-1135G7 / 16GB | WSL2 (Ubuntu 20.04) | 4GB                    |
